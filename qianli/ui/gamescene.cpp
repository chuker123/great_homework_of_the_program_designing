...
victoryWidget->setStyleSheet("background-color: #1a1a2a;"); 
...
m_bgLabels.append(victoryBgLabel);  
...
borderShadow->setColor(Qt::black);   
borderShadow->setBlurRadius(0);       
borderShadow->setOffset(1, 1);       
...
m_stack->addWidget(victoryWidget);
    ...
    gameOverWidget->setStyleSheet("background-color: #1a1a2a;"); 
